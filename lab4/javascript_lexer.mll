...
| ((['0'-'9'])* (('.') (['0'-'9'])+)? (('e') ('-')? (['0'-'9'])*)? | ('0') (['b' 'B']) (['0'-'1'])* | ('0') (['o' 'O']) (['0'-'7'])* | ('0') (['x' 'X']) (['0'-'9' 'a'-'z' 'A'-'Z'])*) as x {ignore x; NUMBER( js_float_of_string x )} (* Number : float (len = 2) (kw = false) *)
...
| ("Infinity") as x {ignore x; VALUE1_2_0(x)} (* Value1_2_0 : string (len = 2) (kw = false) *)
| ("NaN") as x {ignore x; VALUE1_1_0(x)} (* Value1_1_0 : string (len = 2) (kw = false) *)
| (('.')) as x {ignore x; EXPR1_19_1(x)} (* Expr1_19_1 : char (len = 1) (kw = false) *)
| (('(')) as x {ignore x; EXPR1_18_1(x)} (* Expr1_18_1 : char (len = 1) (kw = false) *)
| ("log") as x {ignore x; EXPR1_17_2(x)} (* Expr1_17_2 : string (len = 2) (kw = false) *)
| ("console") as x {ignore x; EXPR1_17_0(x)} (* Expr1_17_0 : string (len = 2) (kw = false) *)
| ((':')) as x {ignore x; EXPR1_16_3(x)} (* Expr1_16_3 : char (len = 1) (kw = false) *)
| (('?')) as x {ignore x; EXPR1_16_1(x)} (* Expr1_16_1 : char (len = 1) (kw = false) *)
| ("||") as x {ignore x; EXPR1_15_1(x)} (* Expr1_15_1 : string (len = 2) (kw = false) *)
| ("&&") as x {ignore x; EXPR1_14_1(x)} (* Expr1_14_1 : string (len = 2) (kw = false) *)
...
| (('-')) as x {ignore x; EXPR1_7_1(x)} (* Expr1_7_1 : char (len = 1) (kw = false) *)
