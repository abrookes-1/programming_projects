# Aidan Brookes - Individual Homework #4 Repository
...
```
git clone https://github.com/mines-csci400/f20b-user-abrookes-hw04.git
cd f20b-user-abrookes-hw04
```
...
repository:
```
https://github.com/mines-csci400/f20b-user-abrookes-hw04.git
```
...
```
git remote add upstream https://github.com/mines-csci400/f20b-assignment-hw04.git
