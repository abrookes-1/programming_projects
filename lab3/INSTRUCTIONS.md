# Aidan Brookes - Individual Lab #3 Repository
...
```
git clone https://github.com/mines-csci400/f20b-user-abrookes-lab3.git
cd f20b-user-abrookes-lab3
```
...
repository:
```
https://github.com/mines-csci400/f20b-user-abrookes-lab3.git
```
...
```
git remote add upstream https://github.com/mines-csci400/f20b-assignment-lab3.git
